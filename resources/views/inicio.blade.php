...
<style>
    @import url('https://fonts.googleapis.com/css2?family=Fira+Code:wght@300;400;500;700&family=Inter:wght@400;700;800&family=Lora:wght@400;500;700&family=Roboto:wght@400;700&family=Ubuntu:wght@400;500;700&display=swap');
...
<body class="bg-slate-200">
    <header class="flex justify-between top-0 px-3 items-center py-3 fixed w-full z-10 bg-white shadow-lg">
        ...
        <div class="flex gap-14 justify-between" style="width: 25rem">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route("chat_name") }}" class="w-10 h-10 rounded-full bg-slate-200 flex items-center justify-center">
            ...
            <div class="w-10 h-10  rounded-full bg-slate-200 flex items-center justify-center imgPerfil">
                <img src="{{ $user->profile_photo_path  }}" class="w-full h-full rounded-full imagePerfil" alt=""
                    title="Conta">
            </div>
            ...
            <div class="w-full">
                <a href="{{ route("perfil_name") }}"
                    ...
                    <div class="w-10 h-10 rounded-full  bg-orange-400-700 flex items-center justify-center">
                        <img src="{{ $user->profile_photo_path }}" class="w-full h-full rounded-full" alt=""
                            title="Conta">
                    </div>
    ...
    <main class="flex flex-col justify-center mx-auto items-center pt-24  ">
        <section class="px-2   bg-white rounded-md py-3 mb-3" style="width: 500px; height: 8rem;">
            ...
            <div class=" flex items-center gap-2 ">
                <div class="w-10 h-10 rounded-full bg-zinc-800">
                    <img src="{{ $user->profile_photo_path }}" alt="foto de perfil" title="Foto de perfil"
                        class="w-full h-full rounded-full imagePerfil">
                </div>

                <div class="bg-slate-200 w-11/12 h-10 flex cursor-pointer rounded-full pensando">
        ...
        <section class="px-2 h-[30rem] w-[500px] flex justify-center items-center  rounded-md mb-3 py-3">
            <p class="text-2xl text-slate-600 animate-pulse">Sem nem uma publicação por enquanto</p>
       </section>  
        @else
        @foreach ($posts as $post )
        <section class="px-2 my-2 bg-white rounded-md py-3" style="width: 500px;">
            <div>
                <div class="flex justify-between px-1">
                    <div class="flex gap-2 items-center">
                        <div class="w-10 h-10 rounded-full cursor-pointer bg-zinc-800">
                            <img src="{{ asset($post->profile_photo_path) }}" alt="" title="Foto de perfil"
                                class="w-full h-full rounded-full imagePerfil">
                        </div>
                    <a href="{{ route("outro_perfil",["id"=>$post->user_id]) }}">
                            <h2 class="font-bold"><button type="submit">{{ $post->name }}</button></h2>
                            <span class="font-light " style="font-size: 15px"></span>
                        </a>
                    </div>

                    <div class="flex items-center gap-2">
                        <p class="flex mb-2 cursor-pointer font-bold">...</p>
                        <i class="bi bi-x-lg font-bold cursor-pointer"></i>
                    </div>
                </div>
            </div>
            ...
            <div>
                <img class="rounded-md" src="{{ asset($post->way) }}" alt="">
                ...
                <div class="flex justify-between  mt-3 gap-3">
                    ...
                    <div class="flex hover:bg-slate-100 py-1 cursor-pointer justify-center gap-2 font-bold  w-1/3">
                        <img src="{{ asset("build/assets/img/like-svgrepo-com.svg") }}"
                            class="w-6 flex items-center text-slate-500" alt="" srcset="">
                        <p class="font-bold text-slate-500">Gosto</p>
                    </div>

                    <div class="flex hover:bg-slate-100 py-1 cursor-pointer justify-center gap-2 font-bold  w-1/3">
                        <i class="bi bi-chat-left-fill text-slate-500"></i>
        ...
        <div class="mt-2 ms-3  sticky top-16 ">
            <a href="#" class="flex items-center gap-2 outline-none">
                <div class="w-12 h-12 rounded-full">
                    <img src="{{ $user->profile_photo_path }}" class="w-full h-full rounded-full bg-slate-400" alt="">
                </div>
                <div>
                    <span class="flex flex-col font-bold text-md">{{ $user->name }}</span>
                    <small>descrition</small>
                </div>
            </a>
        </div>
